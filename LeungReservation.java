...
public class LeungReservation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView myImageView = (ImageView) findViewById(R.id.leung_1200);
        myImageView.setImageResource(R.drawable.leung_1200);
        ...
        GoToLeungReservationActivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LeungReservation.this, LeungReservation.class);
